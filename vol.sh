...
wait_for_resources_or_arrival 0 id0_imagenet_resnet50_sync_batch256 2 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id0_imagenet_resnet50_sync_batch256 시작" > ${SAVEPATH}/id0_imagenet_resnet50_sync_batch256_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id0_imagenet_resnet50_sync_batch256_vol.yaml
...
wait_for_resources_or_arrival 1393 id6_imagenet_resnet50_sync_batch256 2 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id6_imagenet_resnet50_sync_batch256 시작" > ${SAVEPATH}/id6_imagenet_resnet50_sync_batch256_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id6_imagenet_resnet50_sync_batch256_vol.yaml
...
wait_for_resources_or_arrival 1727 id7_imagenet_resnet50_sync_batch512 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id7_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id7_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id7_imagenet_resnet50_sync_batch512_vol.yaml
...
wait_for_resources_or_arrival 2661 id8_cifar10_resnet44_sync_batch2048 2 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id8_cifar10_resnet44_sync_batch2048 시작" > ${SAVEPATH}/id8_cifar10_resnet44_sync_batch2048_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id8_cifar10_resnet44_sync_batch2048_vol.yaml
...
wait_for_resources_or_arrival 5413 id15_imagenet_resnet50_sync_batch512 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id15_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id15_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id15_imagenet_resnet50_sync_batch512_vol.yaml
...
wait_for_resources_or_arrival 5806 id16_imagenet_resnet50_sync_batch1024 8 vol
...
wait_for_resources_or_arrival 8665 id22_imagenet_resnet50_sync_batch1024 8 vol
...
kubectl apply -f ${TFPATH}/net_script/id22_imagenet_resnet50_sync_batch1024_vol.yaml
...
wait_for_resources_or_arrival 9123 id23_imagenet_vgg16_sync_batch512 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id23_imagenet_vgg16_sync_batch512 시작" > ${SAVEPATH}/id23_imagenet_vgg16_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id23_imagenet_vgg16_sync_batch512_vol.yaml
...
wait_for_resources_or_arrival 10034 id29_cifar10_resnet44_sync_batch8192 8 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id29_cifar10_resnet44_sync_batch8192 시작" > ${SAVEPATH}/id29_cifar10_resnet44_sync_batch8192_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id29_cifar10_resnet44_sync_batch8192_vol.yaml
