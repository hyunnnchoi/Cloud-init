...
wait_for_resources_or_arrival 0 id0_squad_bert_sync_batch8 2 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id0_squad_bert_sync_batch8_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id0_squad_bert_sync_batch8_k8s.yaml
wait_for_pod_scheduling id0_squad_bert_sync_batch8 2


# 작업: id1_squad_bert_sync_batch32 (모델: bert, 워커: 8, 도착시간: 822초)
wait_for_resources_or_arrival 822 id1_squad_bert_sync_batch32 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id1_squad_bert_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id1_squad_bert_sync_batch32_k8s.yaml
...
wait_for_resources_or_arrival 1524 id2_imagenet_googlenet_sync_batch1024 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id2_imagenet_googlenet_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id2_imagenet_googlenet_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 3372 id6_imagenet_inception3_sync_batch256 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id6_imagenet_inception3_sync_batch256_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id6_imagenet_inception3_sync_batch256_k8s.yaml
...
wait_for_resources_or_arrival 4831 id7_speech_whisper_sync_batch32 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id7_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id7_speech_whisper_sync_batch32_k8s.yaml
...
wait_for_resources_or_arrival 5493 id8_imagenet_densenet100_k12_sync_batch1024 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id8_imagenet_densenet100_k12_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id8_imagenet_densenet100_k12_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 7322 id9_imagenet_resnet44_sync_batch2048 2 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id9_imagenet_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id9_imagenet_resnet44_sync_batch2048_k8s.yaml
...
wait_for_resources_or_arrival 7641 id10_imagenet_resnet110_sync_batch8192 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id10_imagenet_resnet110_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id10_imagenet_resnet110_sync_batch8192_k8s.yaml
...
wait_for_resources_or_arrival 7678 id11_imagenet_resnet44_sync_batch2048 2 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id11_imagenet_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id11_imagenet_resnet44_sync_batch2048_k8s.yaml
...
wait_for_resources_or_arrival 8875 id12_imagenet_densenet100_k12_sync_batch512 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id12_imagenet_densenet100_k12_sync_batch512_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id12_imagenet_densenet100_k12_sync_batch512_k8s.yaml
...
wait_for_resources_or_arrival 9280 id13_imagenet_densenet40_k12_sync_batch4096 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id13_imagenet_densenet40_k12_sync_batch4096_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id13_imagenet_densenet40_k12_sync_batch4096_k8s.yaml
...
wait_for_resources_or_arrival 9674 id14_imagenet_resnet44_sync_batch8192 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id14_imagenet_resnet44_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id14_imagenet_resnet44_sync_batch8192_k8s.yaml
...
wait_for_resources_or_arrival 10469 id15_imagenet_resnet44_sync_batch2048 2 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id15_imagenet_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id15_imagenet_resnet44_sync_batch2048_k8s.yaml
wait_for_pod_scheduling id15_imagenet_resnet44_sync_batch2048 2


# 작업: id16_squad_bert_sync_batch16 (모델: bert, 워커: 4, 도착시간: 10663초)
wait_for_resources_or_arrival 10663 id16_squad_bert_sync_batch16 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id16_squad_bert_sync_batch16_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id16_squad_bert_sync_batch16_k8s.yaml
...
wait_for_resources_or_arrival 11697 id17_imagenet_densenet40_k12_sync_batch8192 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id17_imagenet_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id17_imagenet_densenet40_k12_sync_batch8192_k8s.yaml
...
wait_for_resources_or_arrival 11716 id18_imagenet_resnet50_sync_batch512 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id18_imagenet_resnet50_sync_batch512_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id18_imagenet_resnet50_sync_batch512_k8s.yaml
...
wait_for_resources_or_arrival 11961 id19_imagenet_resnet50_sync_batch1024 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id19_imagenet_resnet50_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id19_imagenet_resnet50_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 12650 id20_imagenet_inception3_sync_batch256 4 k8s
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 13006 id21_imagenet_densenet100_k12_sync_batch1024 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id21_imagenet_densenet100_k12_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id21_imagenet_densenet100_k12_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 13419 id22_imagenet_densenet40_k12_sync_batch8192 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id22_imagenet_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id22_imagenet_densenet40_k12_sync_batch8192_k8s.yaml
...
wait_for_resources_or_arrival 14028 id23_imagenet_resnet110_sync_batch4096 4 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id23_imagenet_resnet110_sync_batch4096_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id23_imagenet_resnet110_sync_batch4096_k8s.yaml
wait_for_pod_scheduling id23_imagenet_resnet110_sync_batch4096 4


# 작업: id24_squad_gpt2_sync_batch32 (모델: gpt2, 워커: 8, 도착시간: 14241초)
wait_for_resources_or_arrival 14241 id24_squad_gpt2_sync_batch32 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id24_squad_gpt2_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id24_squad_gpt2_sync_batch32_k8s.yaml
...
wait_for_resources_or_arrival 14261 id25_imagenet_densenet100_k12_sync_batch1024 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id25_imagenet_densenet100_k12_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id25_imagenet_densenet100_k12_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 14491 id26_speech_whisper_sync_batch32 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id26_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id26_speech_whisper_sync_batch32_k8s.yaml
...
wait_for_resources_or_arrival 14760 id27_speech_whisper_sync_batch32 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id27_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id27_speech_whisper_sync_batch32_k8s.yaml
...
wait_for_resources_or_arrival 14787 id28_imagenet_densenet40_k12_sync_batch8192 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id28_imagenet_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id28_imagenet_densenet40_k12_sync_batch8192_k8s.yaml
...
wait_for_resources_or_arrival 15343 id29_imagenet_densenet100_k12_sync_batch1024 8 k8s
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id29_imagenet_densenet100_k12_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id29_imagenet_densenet100_k12_sync_batch1024_k8s.yaml
