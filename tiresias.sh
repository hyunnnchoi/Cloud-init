...
wait_for_resources_or_arrival 0 id0_squad_bert_sync_batch8 2 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id0_squad_bert_sync_batch8_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id0_squad_bert_sync_batch8_tiresias.yaml
wait_for_pod_scheduling id0_squad_bert_sync_batch8 2


# 작업: id1_squad_bert_sync_batch32 (모델: bert, 워커: 8, 도착시간: 822초)
wait_for_resources_or_arrival 822 id1_squad_bert_sync_batch32 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id1_squad_bert_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id1_squad_bert_sync_batch32_tiresias.yaml
...
wait_for_resources_or_arrival 1524 id2_imagenet_googlenet_sync_batch1024 4 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id2_imagenet_googlenet_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id2_imagenet_googlenet_sync_batch1024_tiresias.yaml
...
wait_for_resources_or_arrival 2163 id3_imagenet_vgg16_sync_batch256 2 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id3_imagenet_vgg16_sync_batch256_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id3_imagenet_vgg16_sync_batch256_tiresias.yaml
wait_for_pod_scheduling id3_imagenet_vgg16_sync_batch256 2


# 작업: id4_squad_bert_sync_batch16 (모델: bert, 워커: 4, 도착시간: 2265초)
wait_for_resources_or_arrival 2265 id4_squad_bert_sync_batch16 4 tiresias
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 3372 id6_imagenet_inception3_sync_batch256 4 tiresias
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 4831 id7_speech_whisper_sync_batch32 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id7_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id7_speech_whisper_sync_batch32_tiresias.yaml
...
wait_for_resources_or_arrival 10663 id16_squad_bert_sync_batch16 4 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id16_squad_bert_sync_batch16_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id16_squad_bert_sync_batch16_tiresias.yaml
...
wait_for_resources_or_arrival 11716 id18_imagenet_resnet50_sync_batch512 4 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id18_imagenet_resnet50_sync_batch512_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id18_imagenet_resnet50_sync_batch512_tiresias.yaml
...
wait_for_resources_or_arrival 11961 id19_imagenet_resnet50_sync_batch1024 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id19_imagenet_resnet50_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id19_imagenet_resnet50_sync_batch1024_tiresias.yaml
...
wait_for_resources_or_arrival 12650 id20_imagenet_inception3_sync_batch256 4 tiresias
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 14241 id24_squad_gpt2_sync_batch32 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id24_squad_gpt2_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id24_squad_gpt2_sync_batch32_tiresias.yaml
...
wait_for_resources_or_arrival 14491 id26_speech_whisper_sync_batch32 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id26_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id26_speech_whisper_sync_batch32_tiresias.yaml
...
wait_for_resources_or_arrival 14760 id27_speech_whisper_sync_batch32 8 tiresias
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id27_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id27_speech_whisper_sync_batch32_tiresias.yaml
