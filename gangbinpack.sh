...
wait_for_resources_or_arrival 0 id0_cifar10_resnet44_sync_batch4096 4 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id0_cifar10_resnet44_sync_batch4096_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id0_cifar10_resnet44_sync_batch4096_gangbinpack.yaml
...
wait_for_resources_or_arrival 1993 id15_imagenet_resnet50_sync_batch256 2 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id15_imagenet_resnet50_sync_batch256_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id15_imagenet_resnet50_sync_batch256_gangbinpack.yaml
wait_for_pod_scheduling id15_imagenet_resnet50_sync_batch256 2


# 작업: id16_squad_gpt2_sync_batch32 (모델: gpt2, 워커: 8, 도착시간: 2107초)
wait_for_resources_or_arrival 2107 id16_squad_gpt2_sync_batch32 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id16_squad_gpt2_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id16_squad_gpt2_sync_batch32_gangbinpack.yaml
wait_for_pod_scheduling id16_squad_gpt2_sync_batch32 8


# 작업: id17_speech_whisper_sync_batch32 (모델: whisper, 워커: 8, 도착시간: 2609초)
wait_for_resources_or_arrival 2609 id17_speech_whisper_sync_batch32 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id17_speech_whisper_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id17_speech_whisper_sync_batch32_gangbinpack.yaml
wait_for_pod_scheduling id17_speech_whisper_sync_batch32 8


# 작업: id18_squad_bert_sync_batch8 (모델: bert, 워커: 2, 도착시간: 2852초)
wait_for_resources_or_arrival 2852 id18_squad_bert_sync_batch8 2 gangbinpack
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 2953 id19_imagenet_resnet50_sync_batch512 4 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id19_imagenet_resnet50_sync_batch512_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id19_imagenet_resnet50_sync_batch512_gangbinpack.yaml
wait_for_pod_scheduling id19_imagenet_resnet50_sync_batch512 4


# 작업: id20_squad_gpt2_sync_batch32 (모델: gpt2, 워커: 8, 도착시간: 3048초)
wait_for_resources_or_arrival 3048 id20_squad_gpt2_sync_batch32 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id20_squad_gpt2_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id20_squad_gpt2_sync_batch32_gangbinpack.yaml
...
wait_for_resources_or_arrival 3721 id26_cifar10_resnet110_sync_batch8192 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id26_cifar10_resnet110_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id26_cifar10_resnet110_sync_batch8192_gangbinpack.yaml
...
wait_for_resources_or_arrival 3880 id27_imagenet_vgg16_sync_batch1024 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id27_imagenet_vgg16_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id27_imagenet_vgg16_sync_batch1024_gangbinpack.yaml
wait_for_pod_scheduling id27_imagenet_vgg16_sync_batch1024 8


# 작업: id28_squad_bert_sync_batch32 (모델: bert, 워커: 8, 도착시간: 4260초)
wait_for_resources_or_arrival 4260 id28_squad_bert_sync_batch32 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id28_squad_bert_sync_batch32_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id28_squad_bert_sync_batch32_gangbinpack.yaml
wait_for_pod_scheduling id28_squad_bert_sync_batch32 8


# 작업: id29_squad_bert_sync_batch32 (모델: bert, 워커: 8, 도착시간: 4269초)
wait_for_resources_or_arrival 4269 id29_squad_bert_sync_batch32 8 gangbinpack
# 작업 생성 시간 기록
