...
wait_for_resources_or_arrival 0 id53_cifar10_alexnet_sync_batch32768 8 gangbinpack
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id53_cifar10_alexnet_sync_batch32768_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id53_cifar10_alexnet_sync_batch32768_gangbinpack.yaml
