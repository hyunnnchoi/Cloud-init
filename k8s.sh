...
wait_for_resources_or_arrival 169 id2_imagenet_resnet50_sync_batch512 4 k8s
echo "$(date "+%H:%M:%S.%N") - 작업 id2_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id2_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id2_imagenet_resnet50_sync_batch512_k8s.yaml
...
wait_for_resources_or_arrival 243 id3_cifar10_resnet44_sync_batch4096 4 k8s
echo "$(date "+%H:%M:%S.%N") - 작업 id3_cifar10_resnet44_sync_batch4096 시작" > ${SAVEPATH}/id3_cifar10_resnet44_sync_batch4096_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id3_cifar10_resnet44_sync_batch4096_k8s.yaml
...
wait_for_resources_or_arrival 490 id4_cifar10_resnet44_sync_batch4096 4 k8s
echo "$(date "+%H:%M:%S.%N") - 작업 id4_cifar10_resnet44_sync_batch4096 시작" > ${SAVEPATH}/id4_cifar10_resnet44_sync_batch4096_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id4_cifar10_resnet44_sync_batch4096_k8s.yaml
...
wait_for_resources_or_arrival 2325 id17_imagenet_resnet50_sync_batch1024 8 k8s
...
kubectl apply -f ${TFPATH}/net_script/id17_imagenet_resnet50_sync_batch1024_k8s.yaml
...
wait_for_resources_or_arrival 2369 id18_cifar10_resnet44_sync_batch2048 2 k8s
echo "$(date "+%H:%M:%S.%N") - 작업 id18_cifar10_resnet44_sync_batch2048 시작" > ${SAVEPATH}/id18_cifar10_resnet44_sync_batch2048_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id18_cifar10_resnet44_sync_batch2048_k8s.yaml
...
wait_for_resources_or_arrival 2806 id21_imagenet_vgg16_sync_batch256 2 k8s
echo "$(date "+%H:%M:%S.%N") - 작업 id21_imagenet_vgg16_sync_batch256 시작" > ${SAVEPATH}/id21_imagenet_vgg16_sync_batch256_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id21_imagenet_vgg16_sync_batch256_k8s.yaml
...
wait_for_resources_or_arrival 2864 id22_imagenet_resnet50_sync_batch1024 8 k8s
...
wait_for_resources_or_arrival 4088 id29_cifar10_resnet44_sync_batch8192 8 k8s
