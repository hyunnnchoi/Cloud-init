...
wait_for_resources_or_arrival 3291 id5_cifar10_resnet44_sync_batch2048 2 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id5_cifar10_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id5_cifar10_resnet44_sync_batch2048_colo.yaml
...
wait_for_resources_or_arrival 5493 id8_cifar10_densenet100_k12_sync_batch1024 8 colo
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 7322 id9_cifar10_resnet44_sync_batch2048 2 colo
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 7641 id10_cifar10_resnet110_sync_batch8192 8 colo
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 7678 id11_cifar10_resnet44_sync_batch2048 2 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id11_cifar10_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id11_cifar10_resnet44_sync_batch2048_colo.yaml
...
wait_for_resources_or_arrival 8875 id12_cifar10_densenet100_k12_sync_batch512 4 colo
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 9280 id13_cifar10_densenet40_k12_sync_batch4096 4 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id13_cifar10_densenet40_k12_sync_batch4096_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id13_cifar10_densenet40_k12_sync_batch4096_colo.yaml
...
wait_for_resources_or_arrival 9674 id14_cifar10_resnet44_sync_batch8192 8 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id14_cifar10_resnet44_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id14_cifar10_resnet44_sync_batch8192_colo.yaml
...
wait_for_resources_or_arrival 10469 id15_cifar10_resnet44_sync_batch2048 2 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id15_cifar10_resnet44_sync_batch2048_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id15_cifar10_resnet44_sync_batch2048_colo.yaml
...
wait_for_resources_or_arrival 11697 id17_cifar10_densenet40_k12_sync_batch8192 8 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id17_cifar10_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id17_cifar10_densenet40_k12_sync_batch8192_colo.yaml
...
wait_for_resources_or_arrival 13006 id21_cifar10_densenet100_k12_sync_batch1024 8 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id21_cifar10_densenet100_k12_sync_batch1024_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id21_cifar10_densenet100_k12_sync_batch1024_colo.yaml
...
wait_for_resources_or_arrival 13419 id22_cifar10_densenet40_k12_sync_batch8192 8 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id22_cifar10_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id22_cifar10_densenet40_k12_sync_batch8192_colo.yaml
...
wait_for_resources_or_arrival 14028 id23_cifar10_resnet110_sync_batch4096 4 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id23_cifar10_resnet110_sync_batch4096_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id23_cifar10_resnet110_sync_batch4096_colo.yaml
...
wait_for_resources_or_arrival 14261 id25_cifar10_densenet100_k12_sync_batch1024 8 colo
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 14787 id28_cifar10_densenet40_k12_sync_batch8192 8 colo
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id28_cifar10_densenet40_k12_sync_batch8192_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id28_cifar10_densenet40_k12_sync_batch8192_colo.yaml
...
wait_for_resources_or_arrival 15343 id29_cifar10_densenet100_k12_sync_batch1024 8 colo
# 작업 생성 시간 기록
