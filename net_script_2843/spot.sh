...
wait_for_resources_or_arrival 0 id10_speech_whisper_sync_batch8 2 spot
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id10_speech_whisper_sync_batch8_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id10_speech_whisper_sync_batch8_spot.yaml
...
wait_for_resources_or_arrival 0 id14_squad_gpt2_sync_batch16 4 spot
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 0 id27_squad_bert_sync_batch32 8 spot
# 작업 생성 시간 기록
...
wait_for_resources_or_arrival 0 id41_speech_whisper_sync_batch8 2 spot
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id41_speech_whisper_sync_batch8_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id41_speech_whisper_sync_batch8_spot.yaml
...
wait_for_resources_or_arrival 0 id53_cifar10_alexnet_sync_batch32768 8 spot
# 작업 생성 시간 기록
echo "$(date "+%H:%M:%S.%N")" > ${SAVEPATH}/id53_cifar10_alexnet_sync_batch32768_job_create.txt
kubectl apply -f ${TFPATH}/net_script/id53_cifar10_alexnet_sync_batch32768_spot.yaml
