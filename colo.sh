...
wait_for_resources_or_arrival 0 id0_imagenet_resnet50_sync_batch256 2 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id0_imagenet_resnet50_sync_batch256 시작" > ${SAVEPATH}/id0_imagenet_resnet50_sync_batch256_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id0_imagenet_resnet50_sync_batch256_colo.yaml
...
wait_for_resources_or_arrival 1393 id6_imagenet_resnet50_sync_batch256 2 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id6_imagenet_resnet50_sync_batch256 시작" > ${SAVEPATH}/id6_imagenet_resnet50_sync_batch256_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id6_imagenet_resnet50_sync_batch256_colo.yaml
...
wait_for_resources_or_arrival 1727 id7_imagenet_resnet50_sync_batch512 4 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id7_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id7_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id7_imagenet_resnet50_sync_batch512_colo.yaml
...
wait_for_resources_or_arrival 2661 id8_cifar10_resnet44_sync_batch2048 2 colo
...
wait_for_resources_or_arrival 5413 id15_imagenet_resnet50_sync_batch512 4 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id15_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id15_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id15_imagenet_resnet50_sync_batch512_colo.yaml
...
wait_for_resources_or_arrival 5806 id16_imagenet_resnet50_sync_batch1024 8 colo
...
kubectl apply -f ${TFPATH}/net_script/id16_imagenet_resnet50_sync_batch1024_colo.yaml
wait_for_pod_scheduling id16_imagenet_resnet50_sync_batch1024 8


# 작업: id17_squad_bert_sync_batch32 (모델: bert, 워커: 8, 도착시간: 6127초)
wait_for_resources_or_arrival 6127 id17_squad_bert_sync_batch32 8 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id17_squad_bert_sync_batch32 시작" > ${SAVEPATH}/id17_squad_bert_sync_batch32_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id17_squad_bert_sync_batch32_colo.yaml
...
wait_for_resources_or_arrival 6242 id18_cifar10_resnet44_sync_batch4096 4 colo
...
wait_for_resources_or_arrival 6537 id19_squad_gpt2_sync_batch16 4 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id19_squad_gpt2_sync_batch16 시작" > ${SAVEPATH}/id19_squad_gpt2_sync_batch16_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id19_squad_gpt2_sync_batch16_colo.yaml
...
wait_for_resources_or_arrival 8665 id22_imagenet_resnet50_sync_batch1024 8 colo
...
wait_for_resources_or_arrival 9123 id23_imagenet_vgg16_sync_batch512 4 colo
echo "$(date "+%H:%M:%S.%N") - 작업 id23_imagenet_vgg16_sync_batch512 시작" > ${SAVEPATH}/id23_imagenet_vgg16_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id23_imagenet_vgg16_sync_batch512_colo.yaml
...
wait_for_resources_or_arrival 10034 id29_cifar10_resnet44_sync_batch8192 8 colo
