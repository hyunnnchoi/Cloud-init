...
wait_for_resources_or_arrival 169 id2_imagenet_resnet50_sync_batch512 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id2_imagenet_resnet50_sync_batch512 시작" > ${SAVEPATH}/id2_imagenet_resnet50_sync_batch512_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id2_imagenet_resnet50_sync_batch512_vol.yaml
...
wait_for_resources_or_arrival 243 id3_cifar10_resnet44_sync_batch4096 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id3_cifar10_resnet44_sync_batch4096 시작" > ${SAVEPATH}/id3_cifar10_resnet44_sync_batch4096_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id3_cifar10_resnet44_sync_batch4096_vol.yaml
...
wait_for_resources_or_arrival 490 id4_cifar10_resnet44_sync_batch4096 4 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id4_cifar10_resnet44_sync_batch4096 시작" > ${SAVEPATH}/id4_cifar10_resnet44_sync_batch4096_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id4_cifar10_resnet44_sync_batch4096_vol.yaml
...
wait_for_resources_or_arrival 2325 id17_imagenet_resnet50_sync_batch1024 8 vol
...
kubectl apply -f ${TFPATH}/net_script/id17_imagenet_resnet50_sync_batch1024_vol.yaml
...
wait_for_resources_or_arrival 2369 id18_cifar10_resnet44_sync_batch2048 2 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id18_cifar10_resnet44_sync_batch2048 시작" > ${SAVEPATH}/id18_cifar10_resnet44_sync_batch2048_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id18_cifar10_resnet44_sync_batch2048_vol.yaml
...
wait_for_resources_or_arrival 2864 id22_imagenet_resnet50_sync_batch1024 8 vol
...
wait_for_resources_or_arrival 4087 id28_squad_gpt2_sync_batch32 8 vol
echo "$(date "+%H:%M:%S.%N") - 작업 id28_squad_gpt2_sync_batch32 시작" > ${SAVEPATH}/id28_squad_gpt2_sync_batch32_job_start.txt
kubectl apply -f ${TFPATH}/net_script/id28_squad_gpt2_sync_batch32_vol.yaml
...
wait_for_resources_or_arrival 4088 id29_cifar10_resnet44_sync_batch8192 8 vol
